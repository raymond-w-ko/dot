...
" Last Updated: Tue 21 Sep 2021 10:21:18 AM EDT
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if s:termtrans
      ...
      hi CursorLine guifg=NONE guibg=NONE guisp=#72898f gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    ...
    hi Comment guifg=#72898f guibg=NONE gui=NONE cterm=NONE
  ...
  if s:termtrans
    ...
    hi CursorLine guifg=NONE guibg=NONE guisp=#93a1a1 gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi Terminal guifg=fg guibg=NONE gui=NONE cterm=NONE
  ...
  if get(g:, 'solarized_visibility', '') ==# 'high'
    ...
    hi SpecialKey guifg=#dc322f guibg=NONE gui=NONE cterm=NONE
    hi SpellBad guifg=#6c71c4 guibg=#eee8d5 guisp=#dc322f gui=undercurl cterm=NONE
    hi SpellCap guifg=#6c71c4 guibg=#eee8d5 guisp=#dc322f gui=undercurl cterm=NONE
    hi SpellLocal guifg=#b58900 guibg=#eee8d5 guisp=#cb4b16 gui=undercurl cterm=NONE
    hi SpellRare guifg=#2aa198 guibg=#eee8d5 guisp=#cb4b16 gui=undercurl cterm=NONE
  ...
  elseif get(g:, 'solarized_visibility', '') ==# 'low'
    ...
    hi SpellBad guifg=#6c71c4 guibg=NONE guisp=#6c71c4 gui=undercurl cterm=NONE
    hi SpellCap guifg=#6c71c4 guibg=NONE guisp=#6c71c4 gui=undercurl cterm=NONE
    hi SpellLocal guifg=#b58900 guibg=NONE guisp=#b58900 gui=undercurl cterm=NONE
    hi SpellRare guifg=#2aa198 guibg=NONE guisp=#2aa198 gui=undercurl cterm=NONE
  ...
  if get(g:, 'solarized_diffmode', '') ==# 'high'
    ...
    hi DiffText guifg=#268bd2 guibg=NONE gui=NONE cterm=NONE
  elseif get(g:, 'solarized_diffmode', '') ==# 'low'
  ...
  if get(g:, 'solarized_statusline', '') ==# 'low'
    hi StatusLine guifg=#eee8d5 guibg=#586e75 gui=bold cterm=bold
    hi StatusLineNC guifg=#eee8d5 guibg=#93a1a1 gui=NONE cterm=NONE
    hi TabLineSel guifg=#586e75 guibg=#eee8d5 gui=NONE cterm=NONE
    hi NormalMode guifg=#eee8d5 guibg=#586e75 gui=bold cterm=bold
  else
    hi StatusLine guifg=#eee8d5 guibg=#073642 gui=NONE cterm=NONE
    hi StatusLineNC guifg=#eee8d5 guibg=#586e75 gui=NONE cterm=NONE
    hi TabLineSel guifg=#073642 guibg=#eee8d5 gui=NONE cterm=NONE
    hi NormalMode guifg=#eee8d5 guibg=#073642 gui=NONE cterm=NONE
  endif
  ...
  hi EndOfBuffer guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi ErrorMsg guifg=#dc322f guibg=#fdf6e3 gui=NONE cterm=NONE
  ...
  hi Visual guifg=#93a1a1 guibg=#fdf6e3 gui=NONE cterm=NONE
  hi VisualNOS guifg=NONE guibg=#eee8d5 gui=NONE cterm=NONE
  hi WarningMsg guifg=#cb4b16 guibg=NONE gui=bold cterm=bold
  hi WildMenu guifg=#93a1a1 guibg=#fdf6e3 gui=NONE cterm=NONE
  hi Comment guifg=#93a1a1 guibg=NONE gui=NONE cterm=NONE
  hi Constant guifg=#2aa198 guibg=NONE gui=NONE cterm=NONE
  hi CursorIM guifg=NONE guibg=fg gui=NONE cterm=NONE
  hi Error guifg=#dc322f guibg=#fdf6e3 gui=bold cterm=bold
  ...
  hi InsertMode guifg=#eee8d5 guibg=#2aa198 gui=bold cterm=bold
  hi ReplaceMode guifg=#eee8d5 guibg=#cb4b16 gui=bold cterm=bold
  hi VisualMode guifg=#eee8d5 guibg=#d33682 gui=bold cterm=bold
  hi CommandMode guifg=#eee8d5 guibg=#d33682 gui=bold cterm=bold
  if has('nvim')
    hi! link TermCursor Cursor
...
if s:t_Co >= 256
  ...
  if get(g:, 'solarized_statusline', '') ==# 'low'
    hi StatusLine ctermfg=254 ctermbg=242 cterm=bold
    hi StatusLineNC ctermfg=254 ctermbg=247 cterm=NONE
    hi TabLineSel ctermfg=242 ctermbg=254 cterm=NONE
    hi NormalMode ctermfg=254 ctermbg=242 cterm=bold
  else
    hi StatusLine ctermfg=254 ctermbg=236 cterm=NONE
    hi StatusLineNC ctermfg=254 ctermbg=242 cterm=NONE
    hi TabLineSel ctermfg=236 ctermbg=254 cterm=NONE
    hi NormalMode ctermfg=254 ctermbg=236 cterm=NONE
  endif
  ...
  hi Directory ctermfg=32 ctermbg=NONE cterm=NONE
  hi EndOfBuffer ctermfg=NONE ctermbg=NONE cterm=NONE
  hi ErrorMsg ctermfg=160 ctermbg=230 cterm=NONE
  ...
  hi Search ctermfg=136 ctermbg=NONE cterm=NONE
  ...
  hi Type ctermfg=136 ctermbg=NONE cterm=NONE
  hi Underlined ctermfg=61 ctermbg=NONE cterm=NONE
  hi InsertMode ctermfg=254 ctermbg=37 cterm=bold
  hi ReplaceMode ctermfg=254 ctermbg=166 cterm=bold
  hi VisualMode ctermfg=254 ctermbg=162 cterm=bold
  hi CommandMode ctermfg=254 ctermbg=162 cterm=bold
  if has('nvim')
    hi! link TermCursor Cursor
...
if s:t_Co >= 16
  ...
  if get(g:, 'solarized_statusline', '') ==# 'low'
    hi StatusLine ctermfg=7 ctermbg=10 cterm=bold
    hi StatusLineNC ctermfg=7 ctermbg=14 cterm=NONE
    hi TabLineSel ctermfg=10 ctermbg=7 cterm=NONE
    hi NormalMode ctermfg=7 ctermbg=10 cterm=bold
  else
    hi StatusLine ctermfg=7 ctermbg=0 cterm=NONE
    hi StatusLineNC ctermfg=7 ctermbg=10 cterm=NONE
    hi TabLineSel ctermfg=0 ctermbg=7 cterm=NONE
    hi NormalMode ctermfg=7 ctermbg=0 cterm=NONE
  endif
  ...
  hi Type ctermfg=3 ctermbg=NONE cterm=NONE
  hi Underlined ctermfg=13 ctermbg=NONE cterm=NONE
  hi InsertMode ctermfg=7 ctermbg=6 cterm=bold
  hi ReplaceMode ctermfg=7 ctermbg=9 cterm=bold
  hi VisualMode ctermfg=7 ctermbg=5 cterm=bold
  hi CommandMode ctermfg=7 ctermbg=5 cterm=bold
  if has('nvim')
    hi! link TermCursor Cursor
