**Note: this repository is archived; my active blue-tinted vim theme is [snow](https://github.com/haystackandroid/snow).**
...
- available for [Vim](https://github.com/haystackandroid/seabird#vim-theme), [terminals](https://github.com/haystackandroid/seabird#terminal-themes), and [other stuff](https://github.com/haystackandroid/seabird#other-themes)
...
Download the desired [colourscheme files](https://github.com/haystackandroid/seabird/tree/master/colors) and place in directory `~/.vim/colors/` (Linux/Mac) or `%userprofile%\vimfiles\colors\` (Windows).

#### option B: using a plugin manager

For easy management of Vim colour schemes (and other plugins), try a plugin manager. With [vim-plug](https://github.com/junegunn/vim-plug), for instance, just add `Plug 'haystackandroid/seabird'` to the list of plugins in `vimrc`, then run `PlugUpdate`.
...
To assign themes to specific intervals of the day, try the [night-and-day](https://github.com/haystackandroid/night-and-day) plugin.
...
As of now, this repository provides the following [terminal configuration files](https://github.com/haystackandroid/seabird/tree/master/terminal):
- [`Xresources`](https://github.com/haystackandroid/seabird/tree/master/terminal/Xresources) files for **xterm** and **urxvt** (Linux)
- [`.colorscheme`](https://github.com/haystackandroid/seabird/tree/master/terminal/konsole%20%26%20qterminal) files for **Konsole** and **QTerminal** (Linux)
- [`gsettings`](https://github.com/haystackandroid/seabird/tree/master/terminal/pantheon-terminal.md) 'command blocks' for **pantheon-terminal** (elementary OS)
- [`.terminal`](https://github.com/haystackandroid/seabird/tree/master/terminal/osx-terminal) files for **terminal.app** (OSX)
- [`.itermcolors`](https://github.com/haystackandroid/seabird/tree/master/terminal/iterm2) files for **iTerm2** (OSX)

For **GNOME Terminal**, run the [install script](https://github.com/haystackandroid/seabird/tree/master/terminal/gnome-terminal) for the desired seabird theme to create a "profile" for it. Then select the profile with the right-click menu, or set the profile as default via Edit > Preferences > Profiles.

Configuration files for other terminals may be added if [requested](https://github.com/haystackandroid/seabird/issues).
