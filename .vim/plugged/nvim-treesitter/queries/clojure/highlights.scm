...
(meta_lit marker: "^" @punctuation.special)
(quoting_lit) @string.escape
(syn_quoting_lit) @string.escape


;; dynamic variables
((sym_lit) @variable.builtin (#match? @variable.builtin "^[*].+[*]$"))

;; parameter-related
; ((sym_lit) @parameter (#match? @parameter "^[&].*$"))

;; gensym
((sym_lit) @variable (#match? @variable "^.*#$"))
...
(list_lit
 .
 (sym_lit) @function
 (#in-plain-string-set? @function "clojure.core.functions"
