...
if [[ $(uname -s) == CYGWIN* ]]; then
  ...
  export PATH="$HOME/npm-global/bin:$HOME/.local/bin:$HOME/vim/bin:$HOME/bin:/usr/lib/ccache/bin:/opt/local/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/sbin:/usr/sbin:/sbin:/usr/bin/core_perl:/opt/aws/bin:/opt/mono/bin:/opt/dropbox:$PATH"
fi
